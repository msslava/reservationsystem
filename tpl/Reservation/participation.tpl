...
<!--				{translate key=Add} <input type="text" id="inviteeAutocomplete" class="input" style="width:250px;"/>
			...
			<div id="inviteeList">
				...
				<p><b>В случае выявления дефектов, либо неработоспособных элементов из данного перечня сотрудником, принимающим данное оборудование после проведения съемки, к ответственному лицу могут быть приняты санкции в соответствии с п. 7.3. договора на выполнение работ и услуг.</b></p>
				<ul/>
			</div>

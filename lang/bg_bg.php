...
class bg_bg extends Language
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['Yes'] = 'Да';
        $strings['No'] = 'Нет';
        $strings['FirstNameRequired'] = 'Введите имя обязательно.';
        $strings['LastNameRequired'] = 'Введите фамилию обязательно.';
        $strings['PwMustMatch'] = 'Пароли не совпадают.';
        $strings['PwComplexity'] = 'Пароль должен быть не менее 6 знаков с буквами, цифрами и символами.';
        $strings['ValidEmailRequired'] = 'Требуется настоящий email адрес.';
        $strings['UniqueEmailRequired'] = 'Текущий email адрес уже зарегистрирован в системе.';
        $strings['UniqueUsernameRequired'] = 'Текущий пользователь уже зарегистрирован в системе.';
        $strings['UserNameRequired'] = 'Введите имя пользователя.';
        $strings['CaptchaMustMatch'] = 'Введите правильно то, что Вы видите на изображении.';
        $strings['Today'] = 'Сегодня';
        $strings['Week'] = 'Неделя';
        $strings['Month'] = 'Месяц';
        $strings['BackToCalendar'] = 'Обратно в календарь';
        $strings['BeginDate'] = 'Начало';
        $strings['EndDate'] = 'Окончание';
        $strings['Username'] = 'Пользователь';
        $strings['Password'] = 'Пароль';
        $strings['PasswordConfirmation'] = 'Подтвердите пароль';
        $strings['DefaultPage'] = 'Началная страница';
        ...
        $strings['NoUpcomingReservations'] = 'Нет предстоящих резервов';
        $strings['UpcomingReservations'] = 'Предстоящие резервы';
        $strings['ShowHide'] = 'Показать/Скрыть';
        $strings['Error'] = 'Ошибка';
        $strings['ReturnToPreviousPage'] = 'Вернуться к предыдущей странице';
        $strings['UnknownError'] = 'Неизвестная ошибка';
        $strings['InsufficientPermissionsError'] = 'Вы не имеете право доступа к этому ресурсу';
        ...
        $strings['CreateReservationHeading'] = 'Запланировать событие';
        $strings['EditReservationHeading'] = 'Редактировать резерв %s';
        $strings['ViewReservationHeading'] = 'Посмотреть %s';
        $strings['ReservationErrors'] = 'Ошибка планирования';
        ...
        $strings['Dashboard'] = 'Доска планирования';
        $strings['Help'] = 'Помощь';
        $strings['Administration'] = 'Администрирование';
        $strings['About'] = 'Сведения';
        ...
        $strings['GroupReservations'] = 'Групповой резерв';
        $strings['ResourceReservations'] = 'Резерв оборудования';
        $strings['Customization'] = 'Персонализация';
        $strings['Attributes'] = 'Атрибуты';
		$strings['AccountActivation'] = 'Активировать профиль';

<?php /* Smarty version Smarty-3.1.7, created on 2013-12-20 20:32:29
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/reservationsystem/lib/Common/../../lang/en_us/ReservationCreated.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179791658152b49b4dbd2911-31726717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c378e944068388fad5839a1689cdee8db712a84a' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/reservationsystem/lib/Common/../../lang/en_us/ReservationCreated.tpl',
      1 => 1387178874,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179791658152b49b4dbd2911-31726717',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52b49b4dc60f4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b49b4dc60f4')) {function content_52b49b4dc60f4($_smarty_tpl) {?>
<?php echo $_smarty_tpl->getSubTemplate ('..\..\tpl\Email\emailheader.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	Начало: <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['StartDate']->value,'key'=>'reservation_email'),$_smarty_tpl);?>
<br/>
	Окончание: <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['formatdate'][0][0]->FormatDate(array('date'=>$_smarty_tpl->tpl_vars['EndDate']->value,'key'=>'reservation_email'),$_smarty_tpl);?>
<br/>
...
<br/>
		<?php } ?>
		<?php }else{ ?>
		Оборудование: <?php echo $_smarty_tpl->tpl_vars['ResourceName']->value;?>
<br/>
	<?php }?>

	Название проекта: <?php echo $_smarty_tpl->tpl_vars['Title']->value;?>
<br/>
	Описание: <?php echo nl2br($_smarty_tpl->tpl_vars['Description']->value);?>
<br/>

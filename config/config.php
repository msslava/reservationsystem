...
$conf['settings']['script.url'] = 'http://192.168.3.52/reservationsystem/Web';
...
$conf['settings']['image.upload.directory'] = 'http://192.168.3.52/reservationsystem/Web/uploads/images';
...
$conf['settings']['database']['user'] = 'reservation';
$conf['settings']['database']['password'] = 'password';
$conf['settings']['database']['hostspec'] = '127.0.0.1';
$conf['settings']['database']['name'] = 'reservationsystem';
